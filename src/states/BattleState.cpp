...
void BattleState::initMatch() {
    ...
    pyraView = std::make_unique<CharacterView>(player1.getCharacter(0), "D:/B3/CodeFighter/assets/images/pyra_python.png", font, pyraX, charY, 0.4f);
    javaTronView = std::make_unique<CharacterView>(player2.getCharacter(0), "D:/B3/CodeFighter/assets/images/java_tron.png", font, javaX, charY, 0.4f);
