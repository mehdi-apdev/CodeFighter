...
#include "../../include/MenuState.h" // Pour revenir au menu à la fin (optionnel)
#include <iostream>
...
void BattleState::initMatch() {
    ...
    if (!backgroundTexture.loadFromFile("C:/Users/Pawla/OneDrive/Bureau/Bac3/jeux/codeF/playgroundcodeblocks/assets/images/background_battle.png")) {
        // Fallback
    }
    backgroundSprite.setTexture(backgroundTexture);

    // Scaling pour 1920x1080 (valeurs codées en dur ou récupérées de window.getSize())
    ...
    pyraView = std::make_unique<CharacterView>(player1.getCharacter(0), "C:/Users/Pawla/OneDrive/Bureau/Bac3/jeux/codeF/playgroundcodeblocks/assets/images/pyra_python.png", font, pyraX, charY, 0.4f);
    javaTronView = std::make_unique<CharacterView>(player2.getCharacter(0), "C:/Users/Pawla/OneDrive/Bureau/Bac3/jeux/codeF/playgroundcodeblocks/assets/images/java_tron.png", font, javaX, charY, 0.4f);
...
void BattleState::render(GameController& game, sf::RenderWindow& window) {
    // Note: Le game.render() a déjà effacé l'écran et dessiné le backgroundSprite.
